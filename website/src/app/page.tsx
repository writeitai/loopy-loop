  ...
  return (
    <div className="container mx-auto flex flex-col items-center px-4 py-24 text-center sm:py-32">
      ...
      <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
        <span className="font-semibold text-foreground">loopy-loop</span> turns a
        goal into an inspectable, resumable loop of agent iterations — plan,
        implement, evaluate, record evidence, repeat — that runs until the goal is
        met. State lives in git and files, never hidden inside a chat transcript.
      </p>
      ...
      <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
        ...
        <a
          href="https://github.com/writeitai/loopy-loop"
          target="_blank"
          rel="noreferrer"
