...
export const docsNavigation: NavItem[] = [
  ...
  { title: "Success & Control", href: "/docs/success-and-control" },
  { title: "Evaluation", href: "/docs/evaluation" },
  { title: "Child Sessions", href: "/docs/child-sessions" },
  {
    title: "Reference",
    href: "/docs/session-layout",
    children: [
      { title: "Session Layout", href: "/docs/session-layout" },
      { title: "HTTP Contract", href: "/docs/http-contract" },
